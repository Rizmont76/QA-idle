...
export const ACTIVE_CANDIDATE_PROFILE_ID = "phase-6b.2-stage-a-003";
...
export const ACTIVE_CANDIDATE_PARAMETER_VERSION =
...
export const ACTIVE_CANDIDATE_PARAMS = Object.freeze({
  ...
  PARAM_MEANINGFUL_DECISIONS_MAX: 5,
  PARAM_JUNIOR_BASELINE_REQUIRED: true,
  PARAM_MANUAL_BASE_BUGS_PER_TEST: "from versioned Junior snapshot",
  PARAM_REPORT_MONEY_PER_BUG: "from versioned Junior snapshot",
  PARAM_ASSISTANT_MAX_LEVEL: 25,
  PARAM_FIRST_MILESTONE_LEVEL: 8,
  PARAM_CAPSTONE_MILESTONE_LEVEL: 25,
  PARAM_ENDPOINT_ASSISTANT_LEVEL_TARGET: 8,
  PARAM_ASSISTANT_LEVEL_BASE_COST: 200,
  PARAM_ASSISTANT_LEVEL_COST_GROWTH: 1.14,
  PARAM_ASSISTANT_LEVEL_LINEAR_COST: 10,
  PARAM_ASSISTANT_BASE_BUGS_PER_SECOND: 0.8,
  PARAM_ASSISTANT_BUGS_PER_SECOND_PER_LEVEL: 0.2,
  PARAM_FIRST_MILESTONE_PRODUCTION_MULTIPLIER: 1.3,
  PARAM_SUPPORT_IMMEDIATE_PRICE: 120,
  PARAM_SUPPORT_IMMEDIATE_ADD_BUGS_PER_SECOND: 0.22,
  PARAM_SUPPORT_TRAINING_PRICE: 160,
  PARAM_SUPPORT_TRAINING_COST_MULTIPLIER: 0.76,
  PARAM_SUPPORT_OFFLINE_PRICE: 150,
  PARAM_SUPPORT_OFFLINE_UNLOCK_LEVEL: 5,
  PARAM_SUPPORT_TRAINING_UNLOCK_LEVEL: 2,
  PARAM_OFFLINE_TIME_CAP_SECONDS: 7200,
  PARAM_OFFLINE_EFFICIENCY_BASE: 0.35,
  PARAM_OFFLINE_EFFICIENCY_WITH_SUPPORT: 0.62,
